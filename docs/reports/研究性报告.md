...
### 课程评价页面的实现效果
根据以上详细设计内容，我们可以实现如图5.1所示的课程评价浏览页面，中间以列表的形式显示所有的评价，评价中展示评价人、打分、评价文本内容、点赞/点踩按钮以及点赞/点踩数量。
![图5.1 课程评价浏览页面](./images/课程评价页面1.png)
另外，根据以上详细设计内容，我们可以实现如图5.2所示的课程评价提交弹窗。用户可以输入评分、评论，并点击“确定”按钮进行提交。
![图5.2 课程评价填写弹窗](./images/课程评价页面2.png)
...
附件 1：珞珈生活-开发文档-程序清单.docx
附件 2：珞珈生活-开发文档-结题报告.docx
附件 3：珞珈生活-开发文档-软件测试分析报告.docx
附件 4：珞珈生活-开发文档-软件测试计划.docx
附件 5：珞珈生活-开发文档-软件设计文档.docx
附件 6：珞珈生活-开发文档-小组代码规范.docx
附件 7：珞珈生活-开发文档-需求定义.docx
附件 8：珞珈生活-开发文档-需求规格说明.docx
附件 9：珞珈生活-开发文档-用户手册.docx

## 源程序

附件 10：WHU-2020HYAP02.zip
...
附件 11：珞珈生活-标准-小组代码规范.pdf

## 其他

附件 12：珞珈生活-测试用例.xlsx